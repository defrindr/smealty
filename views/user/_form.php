        ...
        <div class="user-form">
            ...
            <div class="">
                ...
                <p>
                    ...
                    <?= $form->field($model, 'divisi_id')->dropDownList(ArrayHelper::map(Divisi::find()->all(), 'id', 'nama_divisi'),[
                            'prompt' => "select"
                        ]) ?>
                    ...
                    ?>
                    <?= $form->field($model, 'ttd')->widget(\kartik\file\FileInput::className(), [
                        'options' => ['accept' => 'image/*'],
                        'pluginOptions' => [
                            'allowedFileExtensions' => ['jpg', 'png', 'jpeg', 'gif', 'bmp'],
                            'maxFileSize' => 250,
                    ...
                    ?>
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-3">
                                <?= Html::img(["uploads/" . $model->ttd], ["width" => "150px"]); ?>
                            </div>
                        </div>
                    <?php
                    }
